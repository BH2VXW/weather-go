...
func GetWeather(cityName string) string {
	...
	if cityCode != "" {
		...
		//fmt.Println(dat)
		fmt.Println("城市/地区：", dat.Weatherinfo.City)
		fmt.Println("天气：", dat.Weatherinfo.Weather)
		fmt.Println("气温：", dat.Weatherinfo.Temp1, "~", dat.Weatherinfo.Temp2)
		return "---------------------"
	}

	return "没有查询到该地区的天气情况"
}
